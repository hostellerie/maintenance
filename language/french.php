...
$LANG_confignames['maintenance'] = array(
    ...
    'retry_after' => 'Délai Retry-After envoyé avec les réponses HTTP 503'
);
...
$LANG_MAINTENANCE = array(
    ...
    'documentation_text' => 'Les utilisateurs autorisés contournent le mode maintenance. Les requêtes bloquées reçoivent HTTP 503, des en-têtes anti-cache et le délai Retry-After configuré. La page publique ne contient aucun formulaire de connexion. Les opérateurs utilisent l\'URL de connexion Maintenance séparée, qui délègue l\'authentification à Geeklog et utilise les extensions du formulaire de connexion Geeklog lorsqu\'elles sont disponibles.',
    'login_url_title' => 'URL de connexion autorisée',
    'login_url_help' => 'Enregistrez cette URL opérationnelle avant d\'activer le mode maintenance. Elle est volontairement absente de la page publique, mais les identifiants du compte et les permissions Geeklog restent les véritables contrôles de sécurité.',
